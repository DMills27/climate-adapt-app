...
<!-- </div> -->
* Step 2: 
    * After clicking the "Let's get you started" link, you enter the "field notes" section of the application. The top of the page contains a preamble about how to get started with the farming method that was recommended, and the type f materials.  
    * The upper 
* Step 3:
